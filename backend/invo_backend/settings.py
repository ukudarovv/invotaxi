"""
Django settings for invo_backend project.
"""
...
ROOT_URLCONF = 'invo_backend.urls'
...
WSGI_APPLICATION = 'invo_backend.wsgi.application'
ASGI_APPLICATION = 'invo_backend.asgi.application'
